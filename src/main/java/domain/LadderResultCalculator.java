...
public class LadderResultCalculator {
    ...
    public Map<String, String> calculateResults(Ladder ladder, List<String> players, List<String> prizes) {
        validatePlayersAndPrizes(ladder, players, prizes);
        return mapPlayersToPrizes(ladder, players, prizes);
    }

    private void validatePlayersAndPrizes(Ladder ladder, List<String> players, List<String> prizes) {
    ...
    private Map<String, String> mapPlayersToPrizes(Ladder ladder, List<String> players, List<String> prizes) {
